        ...
        >
          ...
          <div>
            <div className="relative h-18 w-18 flex gap-1">
              <button class="p-3 bottom-0 w-12 h-12 rounded-full bg-secondary hover:bg-tertiary bg-center bg-contain">
                <svg
              ...
              <button class="p-2 bottom-0 w-12 h-12 rounded-full bg-red hover:bg-danger-500 bg-center bg-contain">
