...
function ProductEditForm({ label, ...props }) {
  ...
  return (
    <div className="relative flex flex-col">
        ...
        <input
          ...
          className={
            meta.touched && meta.error
              ? " placeholder:text-sm text-sm placeholder-red-400 bg-red bg-opacity-20 border-2" +
      ...
      {meta.touched && meta.error && (
        <div className="absolute tracking-wider text-red text-xs left-2 top-11 pt-2 font-normal">
          {meta.error}
        </div>
      )}
    </div>
